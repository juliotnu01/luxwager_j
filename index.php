  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><input type="text" class="form-control" name="usuario" id="email" placeholder="Usuario"></li>
        <li><input type="text" class="form-control" name="clave" id="password" placeholder="Contraseña"></li>
        <li><input class="btn btn-default" type="submit" value="Ingresar"></li>
      </ul>
      <ul>
      	
       	<li><input class="btn btn-default " type="submit" value="Registrarse" data-toggle="modal" data-target="#myModal"></li>
      </ul>
      </form>
    </div>
  </div>
